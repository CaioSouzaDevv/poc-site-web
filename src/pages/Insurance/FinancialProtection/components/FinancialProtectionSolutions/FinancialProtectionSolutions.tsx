...
const regulationUrl =
  'https://www.cartaotorra.com.br/cartao-torra/protecao-financeira/'

export function FinancialProtectionSolutions() {
  return (
        ...
        <div className="grid gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          <div>
            ...
            <h2 className="mt-4 max-w-[620px] text-4xl font-extrabold leading-tight">
              Proteção para momentos de instabilidade
            </h2>

            <p className="mt-6 max-w-[560px] text-base leading-relaxed text-white/75">
              A Proteção Financeira oferece coberturas para situações previstas
              no seguro, como morte, invalidez, perda de renda e incapacidade
              temporária, respeitando os limites e condições do regulamento.
            </p>
            ...
            <div className="mt-8 space-y-6">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <span className="text-sm text-slate-600">
                    Coberturas, carências, limites, regras e condições devem ser
                    consultados na página oficial do{' '}
                    <a
                      href={regulationUrl}
