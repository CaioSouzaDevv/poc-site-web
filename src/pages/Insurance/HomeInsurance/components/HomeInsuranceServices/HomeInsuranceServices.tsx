...
export function HomeInsuranceServices() {
  return (
        ...
        <div className="grid gap-12 lg:grid-cols-[1fr_1.3fr] lg:items-center">
          <div>
            ...
            <p className="mt-6 max-w-[520px] text-base leading-relaxed text-slate-600">
              Com a Assistência Lar Cartão Torra, você tem acesso a uma rede de
              profissionais capacitados para resolver imprevistos do dia a dia,
