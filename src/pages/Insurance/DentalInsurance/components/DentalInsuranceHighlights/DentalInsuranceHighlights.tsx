import { BadgeCheck, ClipboardList, HeartPulse, ShieldCheck, Smile } from 'lucide-react'
...
const highlights = [
  ...
  },
  {
    icon: HeartPulse,
    title: 'Atendimento',
    description: 'em rede parceira',
  },
  {
    icon: ShieldCheck,
    title: 'Mais economia',
    description: 'e praticidade',
  },
  {
    icon: BadgeCheck,
...
export function DentalInsuranceHighlights() {
  return (
